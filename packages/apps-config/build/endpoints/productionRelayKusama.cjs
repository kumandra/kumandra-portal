...
exports.createKusama = createKusama;
...
function createKusama(t) {
  return {
    ...
    providers: {
      ...
      'light client': 'light://substrate-connect/kusama' // Pinknode: 'wss://rpc.pinknode.io/kusama/explorer' // https://github.com/polkadot-js/apps/issues/5721

    },
    teleport: [1000],
    linked: [// (1) all system parachains (none available yet)
    // ...
    // (2) all common good parachains
    {
      ...
      providers: {
        ...
        OnFinality: 'wss://statemine.api.onfinality.io/public-ws' // 'Patract Elara': 'wss://pub.elara.patract.io/statemine' // See https://github.com/polkadot-js/apps/issues/6292
    ...
    // NOTE: Added alphabetical based on chain name
    {
      ...
      paraId: 2088,
      text: t('rpc.kusama.altair', 'Altair', {
        ns: 'apps-config'
      }),
      providers: {
      ...
      paraId: 2090,
      text: t('rpc.kusama.basilisk', 'Basilisk', {
        ns: 'apps-config'
      }),
      providers: {
      ...
      isUnreachable: true,
      paraId: 2014,
      text: t('rpc.kusama.encointer', 'Encointer Canary', {
        ns: 'apps-config'
      }),
      providers: {
      ...
      paraId: 2024,
      text: t('rpc.kusama.genshiro', 'Genshiro', {
        ns: 'apps-config'
      }),
      providers: {
      ...
      paraId: 2000,
      text: t('rpc.kusama.karura', 'Karura', {
        ns: 'apps-config'
      }),
      providers: {
      ...
      paraId: 2087,
      text: t('rpc.kusama.picasso', 'Picasso', {
        ns: 'apps-config'
      }),
      providers: {
      ...
      isUnreachable: true,
      paraId: 2016,
      text: t('rpc.kusama.sakura', 'Sakura', {
        ns: 'apps-config'
      }),
      providers: {
      ...
      isUnreachable: true,
      paraId: 2013,
      text: t('rpc.kusama.sherpax', 'SherpaX', {
        ns: 'apps-config'
      }),
      providers: {
      ...
      paraId: 2007,
      text: t('rpc.kusama.shiden', 'Shiden', {
        ns: 'apps-config'
      }),
      providers: {
