...
export function createTesting(t, firstOnly, withSort) {
  return expandEndpoints(t, [// alphabetical based on chain name, e.g. Amber, Arcadia, Beresheet, ...
  {
    info: 'aleph',
    text: t('rpc.test.aleph', 'Aleph Zero Testnet', {
      ns: 'apps-config'
    }),
    providers: {
    ...
    info: 'nodle',
    text: t('rpc.test.nodle-arcadia', 'Arcadia', {
      ns: 'apps-config'
    }),
    providers: {
    ...
    info: 'Ares Gladios',
    text: t('rpc.test.ares.network', 'Ares Gladios', {
      ns: 'apps-config'
    }),
    providers: {
    ...
    info: 'edgeware',
    text: t('rpc.test.beresheet', 'Beresheet', {
      ns: 'apps-config'
    }),
    providers: {
    ...
    info: 'bifrost',
    text: t('rpc.test.bifrost', 'Bifrost', {
      ns: 'apps-config'
    }),
    providers: {
    ...
    text: t('rpc.test.clover.finance', 'Clover', {
      ns: 'apps-config'
    }),
    providers: {
    ...
    info: 'dock-testnet',
    isDisabled: true,
    // https://github.com/polkadot-js/apps/issues/5869
    text: t('rpc.test.dock-pos-testnet', 'Dock', {
      ns: 'apps-config'
    }),
    providers: {
    ...
    text: t('rpc.test.encointer.cantillon', 'Encointer Cantillon', {
      ns: 'apps-config'
    }),
    providers: {
    ...
    text: t('rpc.test.flamingfir', 'Flaming Fir', {
      ns: 'apps-config'
    }),
    providers: {
    ...
    info: 'fantour',
    text: t('rpc.test.fantour', 'Fantour', {
      ns: 'apps-config'
    }),
    providers: {
    ...
    info: 'Galital',
    text: t('rpc.test.galital', 'Galital PC2', {
      ns: 'apps-config'
    }),
    providers: {
    ...
    info: 'gamepower',
    text: t('rpc.test.gamepower', 'GamePower', {
      ns: 'apps-config'
    }),
    providers: {
    ...
    info: 'interbtc',
    text: t('rpc.test.interbtc', 'InterBTC', {
      ns: 'apps-config'
    }),
    providers: {
    ...
    info: 'jupiter',
    text: t('rpc.test.jupiter', 'Jupiter', {
      ns: 'apps-config'
    }),
    providers: {
    ...
    info: 'phala',
    text: t('rpc.test.phala', 'Khala (Para2)', {
      ns: 'apps-config'
    }),
    providers: {
    ...
    info: 'kilt',
    text: t('rpc.test.kilt', 'KILT Mashnet', {
      ns: 'apps-config'
    }),
    providers: {
    ...
    info: 'kilt',
    text: t('rpc.test.kilt', 'KILT Peregrine', {
      ns: 'apps-config'
    }),
    providers: {
    ...
    info: 'klugdossier',
    text: t('rpc.KlugDossier', 'Klug Dossier', {
      ns: 'apps-config'
    }),
    providers: {
    ...
    info: 'litentry',
    text: t('rpc.test.litentry', 'Litentry Testnet', {
      ns: 'apps-config'
    }),
    providers: {
    ...
    info: 'acala',
    text: t('rpc.test.mandala', 'Mandala', {
      ns: 'apps-config'
    }),
    providers: {
    ...
    text: t('rpc.manta', 'Manta Testnet', {
      ns: 'apps-config'
    }),
    providers: {
    ...
    text: t('rpc.test.mybank', 'mybank.network', {
      ns: 'apps-config'
    }),
    providers: {
    ...
    info: 'nftmart',
    text: t('rpc.test.nftmart', 'NFTMart', {
      ns: 'apps-config'
    }),
    providers: {
    ...
    info: 'oak-testnet',
    text: t('rpc.test.oak', 'OAK Testnet', {
      ns: 'apps-config'
    }),
    providers: {
    ...
    info: 'opportunity',
    text: t('rpc.test.opportunity', 'Opportunity', {
      ns: 'apps-config'
    }),
    providers: {
    ...
    text: t('rpc.test.origintrail', 'OriginTrail Parachain Testnet', {
      ns: 'apps-config'
    }),
    providers: {
    ...
    info: 'pangolin',
    text: t('rpc.test.pangolin', 'Pangolin', {
      ns: 'apps-config'
    }),
    providers: {
    ...
    info: 'pangoro',
    text: t('rpc.test.pangoro', 'Pangoro', {
      ns: 'apps-config'
    }),
    providers: {
    ...
    text: t('rpc.test.phoenix', 'Phoenix Mashnet', {
      ns: 'apps-config'
    }),
    providers: {
    ...
    info: 'polkadex',
    isDisabled: true,
    // https://github.com/polkadot-js/apps/issues/6312
    text: t('rpc.test.polkadex', 'Polkadex', {
      ns: 'apps-config'
    }),
    providers: {
    ...
    info: 'polymesh',
    text: t('rpc.test.polymesh', 'Polymesh ITN', {
      ns: 'apps-config'
    }),
    providers: {
    ...
    info: 'realis',
    text: t('rpc.test.realis', 'Realis.Network', {
      ns: 'apps-config'
    }),
    providers: {
    ...
    isDisabled: true,
    // https://github.com/polkadot-js/apps/issues/6181
    text: t('rpc.test.riochain', 'RioChain', {
      ns: 'apps-config'
    }),
    providers: {
    ...
    info: 'shibuya',
    text: t('rpc.test.shibuya', 'Shibuya', {
      ns: 'apps-config'
    }),
    providers: {
    ...
    info: 'snowbridge',
    text: t('rpc.test.snowbridge', 'Snowbridge', {
      ns: 'apps-config'
    }),
    providers: {
    ...
    info: 'subgame',
    text: t('rpc.test.subgame', 'SubGame Staging', {
      ns: 'apps-config'
    }),
    providers: {
    ...
    info: 'subspace',
    text: t('rpc.test.subspace', 'Subspace Testnet', {
      ns: 'apps-config'
    }),
    providers: {
    ...
    info: 'laminar',
    text: t('rpc.test.turbulence', 'Turbulence', {
      ns: 'apps-config'
    }),
    providers: {
    ...
    info: 'uniarts',
    text: t('rpc.test.uniarts', 'UniArts', {
      ns: 'apps-config'
    }),
    providers: {
    ...
    text: t('rpc.test.unitv', 'Unit Network', {
      ns: 'apps-config'
    }),
    providers: {
    ...
    info: 'web3games',
    isDisabled: true,
    // https://github.com/polkadot-js/apps/runs/2755409009?check_suite_focus=true
    text: t('rpc.test.web3games', 'Web3Games', {
      ns: 'apps-config'
    }),
    providers: {
    ...
    info: 'zCloak',
    text: t('rpc.test.zCloak', 'zCloak-network', {
      ns: 'apps-config'
    }),
    providers: {
