...
function createRococo(t) {
  return {
    ...
    providers: {
      Parity: 'wss://rococo-rpc.polkadot.io' // OnFinality: 'wss://rococo.api.onfinality.io/public-ws', // After reset, node misses host functions
    ...
    linked: [// these are the base chains
    {
      ...
      paraId: 1000,
      text: t('rpc.rococo.statemint', 'Statemint', {
        ns: 'apps-config'
      }),
      providers: {
    ...
    }, // add any additional parachains here, alphabetical
    {
      ...
      // Rococo reset
      paraId: 2048,
      text: t('rpc.rococo.apron', 'Apron PC1', {
        ns: 'apps-config'
      }),
      providers: {
      ...
      // Rococo reset
      paraId: 9,
      text: t('rpc.rococo.crab', 'Darwinia Crab PC2', {
        ns: 'apps-config'
      }),
      providers: {
      ...
      // Rococo reset
      paraId: 2003,
      text: t('rpc.rococo.eave', 'Steam PC', {
        ns: 'apps-config'
      }),
      providers: {
      ...
      // Rococo reset
      paraId: 1230,
      text: t('rpc.rococo.galital', 'Galital PC1', {
        ns: 'apps-config'
      }),
      providers: {
      ...
      // Rococo reset
      paraId: 2021,
      text: t('rpc.rococo.genshiro', 'Genshiro', {
        ns: 'apps-config'
      }),
      providers: {
      ...
      // Rococo reset
      paraId: 2018,
      text: t('rpc.rococo.halongbay', 'Halongbay', {
        ns: 'apps-config'
      }),
      providers: {
      ...
      // Rococo reset
      paraId: 2088,
      text: t('rpc.rococo.interbtc', 'InterBTC PC1', {
        ns: 'apps-config'
      }),
      providers: {
      ...
      // Rococo reset
      paraId: 18403,
      text: t('rpc.rococo.konomi', 'Komomi Network', {
        ns: 'apps-config'
      }),
      providers: {
      ...
      // Rococo reset
      paraId: 2104,
      text: t('rpc.rococo.singlavender', 'Lavender by SingNetwork', {
        ns: 'apps-config'
      }),
      providers: {
      ...
      // Rococo reset
      paraId: 2043,
      text: t('rpc.rococo.loomnetwork', 'Loom Network', {
        ns: 'apps-config'
      }),
      providers: {
      ...
      // Rococo reset
      paraId: 2021,
      text: t('rpc.rococo.manta', 'Manta PC1', {
        ns: 'apps-config'
      }),
      providers: {
      ...
      // Rococo reset
      paraId: 1286,
      text: t('rpc.rococo.moonrock', 'Moonrock', {
        ns: 'apps-config'
      }),
      providers: {
      ...
      // Rococo reset
      paraId: 2037,
      text: t('rpc.rococo.origintrail', 'OriginTrail Parachain', {
        ns: 'apps-config'
      }),
      providers: {
      ...
      // Rococo reset
      paraId: 18888,
      text: t('rpc.rococo.parami', 'Parami PC2', {
        ns: 'apps-config'
      }),
      providers: {
      ...
      // Rococo reset
      paraId: 1010,
      text: t('rpc.rococo.jupiter', 'Patract Jupiter PC1', {
        ns: 'apps-config'
      }),
      providers: {
      ...
      // Rococo reset
      paraId: 6806,
      text: t('rpc.rococo.phoenix', 'PHOENIX PC1', {
        ns: 'apps-config'
      }),
      providers: {
      ...
      // Rococo reset
      paraId: 1111,
      text: t('rpc.rococo.polkafoundry', 'PolkaFoundry PC1', {
        ns: 'apps-config'
      }),
      providers: {
      ...
      // Rococo reset
      paraId: 2002,
      text: t('rpc.rococo.prism', 'Prism PC1', {
        ns: 'apps-config'
      }),
      providers: {
      ...
      isDisabled: true,
      paraId: 2003,
      text: t('rpc.rococo.standard', 'Standard', {
        ns: 'apps-config'
      }),
      providers: {
      ...
      // Rococo reset
      paraId: 28,
      text: t('rpc.rococo.subsocial', 'Subsocial PC1', {
        ns: 'apps-config'
      }),
      providers: {
      ...
      // Rococo reset
      paraId: 3,
      text: t('rpc.rococo.unitv', 'Unit Network', {
        ns: 'apps-config'
      }),
      providers: {
      ...
      // Rococo reset
      paraId: 2007,
      text: t('rpc.rococo.vln', 'Valibre Network PC', {
        ns: 'apps-config'
      }),
      providers: {
      ...
      paraId: 2050,
      text: t('rpc.rococo.zeitgeist', 'Zeitgeist PC', {
        ns: 'apps-config'
      }),
      providers: {
