...
const chainPolkadot = '#008000'; // Kumandra color #008000
...
export const chainColors = Object.entries({
  ...
  'ZERO.IO': chainZero
}).reduce((colors, [chain, color]) => _objectSpread(_objectSpread({}, colors), {}, {
...
export const specColors = Object.entries({
  ...
  statemint: specStatemint,
  westmint: specWestmint
}).reduce((colors, [spec, color]) => _objectSpread(_objectSpread({}, colors), {}, {
  [sanitize(spec)]: color
}), {});