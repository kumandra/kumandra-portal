...
export function createTesting (t: TFunction, firstOnly: boolean, withSort: boolean): LinkOption[] {
  return expandEndpoints(t, [
    ...
    {
      info: 'kumandra-farmnet',
      text: t('rpc.test.kumandra.farmnet', 'Kumandra Farmnet', { ns: 'apps-config' }),
      providers: {
        'Kumandra Network': 'wss://farm-rpc.kumandra.network'
      }
    },
    {
      info: 'kumandra',
      ...
      providers: {
        'Kumandra Network': 'wss://test-rpc.kumandra.network'
      }
    },
    {
      info: 'ternoa-testnet',
